...
read -rp "Sub Domain (Contoh: rmbl123): " -e sub
DOMAIN=rmblvpn.biz.id
echo $sub > /root/cfku
SUB_DOMAIN=${sub}.rmblvpn.biz.id
CF_ID=vpnrmbl@gmail.com
CF_KEY=b5eebc1dbca6af803e77e29aedc456bad7a5f
echo "rmblvpn.biz.id" > /root/domain
